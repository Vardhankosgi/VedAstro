...
namespace VedAstro.Library
{
    ...
    public class Location
    {
        ...
        public Location()
        {
            ...
            addressServiceClient = new TableServiceClient(Secrets.AzureGeoLocationStorageKey);
            ...
            //get connection & load tables
            addressMetadataServiceClient = new TableServiceClient(Secrets.AzureGeoLocationStorageKey);
            ...
            //get connection & load tables
            coordinatesServiceClient = new TableServiceClient(Secrets.AzureGeoLocationStorageKey);
            ...
            //get connection & load tables
            coordinatesMetadataServiceClient = new TableServiceClient(Secrets.AzureGeoLocationStorageKey);
            ...
            //get connection & load tables
            ipAddressMetadataServiceClient = new TableServiceClient(Secrets.AzureGeoLocationStorageKey);
            ...
            //get connection & load tables
            timezoneServiceClient = new TableServiceClient(Secrets.AzureGeoLocationStorageKey);
            ...
            //get connection & load tables
            timezoneMetadataServiceClient = new TableServiceClient(Secrets.AzureGeoLocationStorageKey);
            timezoneMetadataTableClient = timezoneMetadataServiceClient.GetTableClient(tableNameTimezoneMetadata);

            try
            {
                addressTableClient.CreateIfNotExists();
                addressMetadataTableClient.CreateIfNotExists();
                coordinatesTableClient.CreateIfNotExists();
                coordinatesMetadataTableClient.CreateIfNotExists();
                ipAddressTableClient.CreateIfNotExists();
                ipAddressMetadataTableClient.CreateIfNotExists();
                timezoneTableClient.CreateIfNotExists();
                timezoneMetadataTableClient.CreateIfNotExists();
            }
            catch (Exception e)
            {
                Console.WriteLine($"Failed to auto-create location cache tables: {e.Message}");
            }
        }
        ...
        private void AddToTimezoneTable(GeoLocationTimezoneEntity newRow)
        {
            try
            {
                timezoneTableClient.UpsertEntity(newRow);
            }
            catch (Exception e)
            {
#if DEBUG
                var errorMessage = $"Can't upsert GeoLocationTimezone row : PartKey:{newRow.PartitionKey}, RowKey:{newRow.RowKey}. Error: {e.Message}";
        ...
        private void AddToTimezoneMetadataTable(GeoLocationTimezoneMetadataEntity newRow)
        {
            try
            {
                timezoneMetadataTableClient.UpsertEntity(newRow);
            }
            catch (Exception e)
            {
#if DEBUG
        ...
        private void AddToIpAddressMetadataTable(IpAddressGeoLocationMetadataEntity newRow)
        {
            try
            {
                ipAddressMetadataTableClient.UpsertEntity(newRow);
            }
            catch (Exception e)
            {
#if DEBUG
        ...
        private void AddToAddressTable(AddressGeoLocationEntity newRow)
        {
            try
            {
                addressTableClient.UpsertEntity(newRow);
            }
            catch (Exception e)
            {
#if DEBUG
                var errorMessage = $"Can't upsert AddressGeoLocation row : PartKey:{newRow.PartitionKey}, RowKey:{newRow.RowKey}. Error: {e.Message}";
                Console.WriteLine(errorMessage);
#endif
            }
        }
        ...
        private void AddToCoordinatesTable(CoordinatesGeoLocationEntity newRow)
        {
            try
            {
                coordinatesTableClient.UpsertEntity(newRow);
            }
            catch (Exception e)
            {
#if DEBUG
                var errorMessage = $"Can't upsert CoordinatesGeoLocation row : PartKey:{newRow.PartitionKey}, RowKey:{newRow.RowKey}. Error: {e.Message}";
                Console.WriteLine(errorMessage);
#endif
            }
        }
        ...
        private void AddToIpAddressTable(IpAddressGeoLocationEntity newRow)
        {
            try
            {
                ipAddressTableClient.UpsertEntity(newRow);
            }
            catch (Exception e)
            {
#if DEBUG
                var errorMessage = $"Can't upsert IpAddressGeoLocation row : PartKey:{newRow.PartitionKey}, RowKey:{newRow.RowKey}. Error: {e.Message}";
                Console.WriteLine(errorMessage);
#endif
            }
        }
