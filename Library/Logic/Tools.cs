...
namespace VedAstro.Library
{
    ...
    public static class Tools
    {
        ...
        {
            // If the address is already in "latitude,longitude" coordinate format, parse it directly.
            if (!string.IsNullOrEmpty(address) && address.Contains(","))
            {
                ...
                {
                    // GeoLocation constructor takes (name, longitude, latitude)
                    var parsedGeo = new GeoLocation(address, lon, lat);
                    return new WebResult<GeoLocation>(true, parsedGeo);
                }
            }
        ...
        public static async Task<WebResult<JToken>> ReadFromServerJsonReply(string apiUrl)
        {
            ...
            if (result == null) { var json = new JObject(); json.Add("RawErrorData", "Request failed after retries."); return new WebResult<JToken>(false, json); }
